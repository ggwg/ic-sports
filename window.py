...
ball_image = cv2.imread(os.path.join(dirname, "assets/beach_ball.png"), cv2.IMREAD_UNCHANGED)
head_image = cv2.imread(os.path.join(dirname, "assets/asian.png"), cv2.IMREAD_UNCHANGED)
...
dirname = os.path.dirname(__file__)
filename = os.path.join(dirname, 'assets/background_place_holder.jpg')
print(filename)
